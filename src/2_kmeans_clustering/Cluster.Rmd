...
---
[Previously](https://github.com/STAT540-UBC/team_Undecided/blob/master/src/1_data_inspect_%26_4_diff%20met/Cleaning_methylation_data.Rmd), we performed data inspection to check if further correction of RNA-seq data was needed, and some cleaning of the methylation data.  
...
Now that all our asthma patients have been assigned to their appropriate clusters, we can move to the next stage, [differential expression analysis](https://github.com/STAT540-UBC/team_Undecided/blob/master/src/3_differential_expression/DE_ThreeGroup.Rmd).