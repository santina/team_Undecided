...
# **** ARGUMENTS ****
dataId_arg <- "TESTING" # give a meaningful name to the data generated by this specific run
...
sigGenePairs <- getSigGenePairs("th2high.th2low")
...
plotExpressionCorrelations("control.th2high", "ENSG00000136699.ENSG00000136925")


plotPermDistribution("th2high.th2low", "ENSG00000136699.ENSG00000136925")
# 
