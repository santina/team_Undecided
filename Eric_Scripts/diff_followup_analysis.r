...
# **** ARGUMENTS ****
dataId_arg <- "238deg_1" # give a meaningful name to the data generated by this specific run
...
getSigGenePairs <- function(comparisonCoef, maxExpressionChange = Inf) {
  pValueMatrices[[comparisonCoef]] %>%
    meltPValueMatrix() %>%
    arrange(p_value)
}
...
sigGenePairs <- getSigGenePairs("control.th2high")

filteredGenePairs <- filterGenePairs(sigGenePairs$gene_pair, "control.th2high", 10)
...
plotExpressionCorrelations("control.th2high", "ENSG00000108691.ENSG00000236499")


# plotPermDistribution("control.th2high", "ENSG00000117318.ENSG00000121335")
# 
