...
# **** ARGUMENTS ****
runID_arg <- "238deg_1" # give a meaningful name to the data generated by this specific run
genes_arg <- read.table("gene_list_Eric.txt")[[1]] %>% as.character() #c("ENSG00000135698", "ENSG00000136925", "ENSG00000136699") # list of ensembl gene ids
