...
heatmap.2(big_table,  Rowv = NA, Colv = NA, scale = NULL , trace="none",  dendrogram = "none",
          col=cols, cexCol=0.5, cexRow=1 , margins= c (8,8), srtCol=90 , symm = FALSE,
					breaks = c(0, 0.01, 0.05, 1),
					density.info = "none",
          main = "Methylation: Adjusted p-value of \nassociation between \ncovariate and PC" )
```
...
write.table(Th2highvscontrolRESULTS, file = "processed_data/meth_CtlvsTh2high_ensemblID_weights.txt", row.names = FALSE, quote = FALSE, sep = ",", col.names = TRUE)
...
write.table(Th2lowvshighRESULTS, file = "processed_data/meth_Th2highvsTh2low_ensemblID_weights.txt", row.names = FALSE, quote = FALSE, sep = ",", col.names = TRUE)
